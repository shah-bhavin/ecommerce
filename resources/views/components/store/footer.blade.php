    ...
    <div class="max-w-[1400px] mx-auto px-6 lg:px-12 py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div class="md:col-span-1">
                <h3 class="text-2xl font-light mb-4" style="font-family:Cormorant Garamond;serif;">ABRARI DUBAI</h3>
        ...
        <div class="pt-8 border-t border-[#bcbbb4] flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="body-text">&copy; {{ date('Y') }} Abrari London. All rights reserved.</p>
